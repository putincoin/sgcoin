...
// Copyright (c) 2013 sgcoin Developers
...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // sgcoin: starting difficulty is 1 / 2^12
...
static const int64 nTargetTimespan = 1 * 60 * 60; // sgcoin: every 1 hour
static const int64 nTargetSpacing = 60; // sgcoin: 1 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // sgcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc50c528c1eb85823a0825cc6343e04b942af0a39ef16583b68c228f49ed8aff1");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1389139200;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2937897;
        ...
        assert(block.hashMerkleRoot == uint256("5b2a3f53f605d62c53e62932dac6925e3d74afa5a4b459745c36d42d0ed26a69"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // sgcoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
